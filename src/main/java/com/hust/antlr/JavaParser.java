...
public class JavaParser extends Parser {
	...
	public final PackageDeclarationContext packageDeclaration() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la - 51)) & ~0x3f) == 0 && ((1L << (_la - 51)) & 32767L) != 0 || _la == AT
						|| _la == IDENTIFIER) {
					{
						{
							setState(272);
	...
	public final EnumDeclarationContext enumDeclaration() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la - 51)) & ~0x3f) == 0 && ((1L << (_la - 51)) & 32767L) != 0 || _la == AT
						|| _la == IDENTIFIER) {
					{
						setState(394);
						enumConstants();
	...
	public final GenericInterfaceMethodDeclarationContext genericInterfaceMethodDeclaration()
		...
		GenericInterfaceMethodDeclarationContext _localctx = new GenericInterfaceMethodDeclarationContext(_ctx,
				getState());
			...
			enterOuterAlt(_localctx, 1);
			{
				...
				switch (getInterpreter().adaptivePredict(_input, 74, _ctx)) {
					case 1: {
						...
						_errHandler.sync(this);
						_la = _input.LA(1);
						if ((((_la - 3)) & ~0x3f) == 0 && ((1L << (_la - 3)) & 9223090579141953573L) != 0 || _la == AT
								|| _la == IDENTIFIER) {
							{
								setState(711);
								receiverParameter();
					...
					case 3: {
						...
						_errHandler.sync(this);
						_la = _input.LA(1);
						if ((((_la - 3)) & ~0x3f) == 0 && ((1L << (_la - 3)) & 9223090579141986341L) != 0 || _la == AT
								|| _la == IDENTIFIER) {
							{
								setState(719);
								formalParameterList();
						...
						_prevctx = _localctx;
						{
							...
							switch (getInterpreter().adaptivePredict(_input, 172, _ctx)) {
								...
								case 15: {
									...
									_la = _input.LA(1);
									if (!(_la == INC || _la == DEC)) {
										((ExpressionContext) _localctx).postfix = (Token) _errHandler
												.recoverInline(this);
									} else {
										if (_input.LA(1) == Token.EOF)
											matchedEOF = true;
		...
		try {
			...
			switch (getInterpreter().adaptivePredict(_input, 179, _ctx)) {
				...
				case 4:
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
					if ((((_la - 18)) & ~0x3f) == 0 && ((1L << (_la - 18)) & 281466386776065L) != 0 || _la == AT
							|| _la == IDENTIFIER) {
						{
							setState(1510);
							lambdaLVTIList();
	...
	public final NonWildcardTypeArgumentsOrDiamondContext nonWildcardTypeArgumentsOrDiamond()
			throws RecognitionException {
		NonWildcardTypeArgumentsOrDiamondContext _localctx = new NonWildcardTypeArgumentsOrDiamondContext(_ctx,
				getState());
